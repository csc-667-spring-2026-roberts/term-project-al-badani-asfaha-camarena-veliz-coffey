...
export async function up(pgm: MigrationBuilder): Promise<void> {
  // Drop NOT NULL safely — catches error if column doesn't exist
  pgm.sql(`DO $$ BEGIN
    ALTER TABLE cards ALTER COLUMN rank DROP NOT NULL;
  EXCEPTION WHEN undefined_column THEN NULL; END $$`);
  pgm.sql(`DO $$ BEGIN
    ALTER TABLE cards ALTER COLUMN suit DROP NOT NULL;
  EXCEPTION WHEN undefined_column THEN NULL; END $$`);
